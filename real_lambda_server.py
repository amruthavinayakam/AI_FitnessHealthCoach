...
<body>
    ...
    def test_workout_lambda(self):
        ...
        try:
            ...
            print(f"🔄 Invoking workout-generator Lambda...")
            ...
            self.send_json_response({
                "status": "error",
                "message": f"Failed to invoke Lambda: {str(e)}",
                "lambda_function": "workout-generator"
            })
    ...
    def test_meal_lambda(self):
        ...
        try:
            ...
            print(f"🔄 Invoking meal-planner Lambda...")
            ...
            if response_payload.get('statusCode') == 200:
                ...
                result = {
                    "status": "success",
                    "message": "REAL meal planning successful!",
    ...
    def handle_chat_api(self):
        ...
        try:
            ...
            # Call the main fitness coach handler Lambda
            payload = {
                'body': json.dumps({
                    'username': user_id,
                    'userId': user_id,
            ...
            print(f"🔄 Invoking fitness-coach-handler Lambda...")
            ...
            if response_payload.get('statusCode') == 200:
                ...
                result = {
                    "status": "success",
                    "message": "REAL Lambda handler response",
                ...
                result = {
                    "status": "error",
                    "message": "Lambda handler returned error",
                    "lambda_response": response_payload
                }
            ...
            self.send_json_response({
                "status": "error",
                "message": f"Failed to invoke Lambda handler: {str(e)}",
                "lambda_function": "fitness-coach-handler"
            })
