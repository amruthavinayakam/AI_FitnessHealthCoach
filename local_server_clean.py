...
Clean version using only Enhanced Nutrition Database (no Spoonacular).
"""
...
<head>
    ...
    <title>🎯 Fitness Health Coach - Enhanced Nutrition System</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Enhanced Nutrition System - localhost:8080</p>
        </div>
        ...
        <div class="status-grid">
            <div class="status-card">
                ...
                <p>Fitness Knowledge & Enhanced Nutrition Database active</p>
            </div>
            <div class="status-card">
            ...
            <div class="status-card">
                <h3>🍽️ Nutrition Database</h3>
                <div class="status-indicator">✅</div>
                <p>USDA FoodData Central + Custom Recipes</p>
            </div>
        </div>
        ...
        <div class="demo-section">
            ...
            <div class="demo-buttons">
                ...
                <button class="demo-btn" onclick="testNutritionPlanning()">🍽️ Test Enhanced Nutrition Database</button>
        ...
        <div class="footer">
            <p>🎉 Fitness Health Coach with Enhanced Nutrition Database</p>
    ...
    <script>
        ...
        async function testNutritionPlanning() {
            updateResponse("🔄 Testing Enhanced Nutrition Database...");
            try {
                const response = await fetch('/api/nutrition?goal=muscle_gain&calories=2200');
                const data = await response.json();
                updateResponse(`✅ Enhanced Nutrition Database Test Results:\\n\\n${JSON.stringify(data, null, 2)}`);
            } catch (error) {
                updateResponse(`❌ Error: ${error.message}`);
            }
        }
    ...
    def handle_config_api(self):
        ...
        result = {
            ...
            "configured": True,
            "description": "Enhanced Nutrition Database with USDA FoodData Central",
            "data_sources": ["USDA FoodData Central", "Custom Recipe Database"],
            "features": ["30+ foods", "6+ recipes", "Accurate nutrition data"]
        }
    ...
    async def process_chat_message(self, message, user_id):
        ...
        nutrition_keywords = ["meal", "diet", "nutrition", "food", "calories", "healthy"]
        ...
        if has_nutrition or "muscle" in message.lower():
            ...
            response["responses"]["nutrition"] = {
                ...
                "meal_plan": nutrition_plan["meal_plan"]["weekly_plan"][0] if nutrition_plan["meal_plan"].get("weekly_plan") else {},
                "mcp_enhancement": "Enhanced with USDA FoodData Central nutrition database"
            }
    ...
    def generate_ai_response(self, message, has_fitness, has_nutrition):
        ...
        if has_fitness and has_nutrition:
            return {
                "message": "I've analyzed your request for both fitness and nutrition guidance. I'm providing you with a comprehensive plan that includes exercise recommendations enhanced with our Fitness Knowledge MCP server for proper form and safety, plus an optimized meal plan from our Enhanced Nutrition Database with USDA FoodData Central for accurate nutrition information.",
                ...
                "mcp_enhancements": [
                    ...
                    "Enhanced Nutrition Database: USDA FoodData Central with custom recipes"
                ]
            }
        elif has_fitness:
            return {
            ...
            return {
                "message": "I've identified your nutrition-related request. I'm providing meal planning recommendations enhanced with our Enhanced Nutrition Database, which includes USDA FoodData Central nutrition data, custom recipes, and accurate macro calculations.",
                "bedrock_simulation": "This would normally be generated by AWS Bedrock Claude model", 
                "mcp_enhancements": [
                    "Enhanced Nutrition Database: USDA nutrition data with custom meal planning"
                ]
            }
        else:
            return {
                "message": "I'm here to help with your fitness and nutrition journey! Ask me about workouts, exercises, meal planning, or nutrition advice. I have access to enhanced fitness knowledge and accurate nutrition data through our MCP server integration.",
                "bedrock_simulation": "This would normally be generated by AWS Bedrock Claude model",
                "mcp_enhancements": [
                    "Ready to use Fitness Knowledge MCP and Enhanced Nutrition Database as needed"
                ]
            }
